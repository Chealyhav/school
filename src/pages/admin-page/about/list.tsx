...
import { AboutProps, BannerHomeProps, BannerProps } from "@/interface/home";
        ...
        {data.map((x) => (
          <div className="">
            <div className="grid md:grid-cols-4 grid-cols-1 gap-4">
              <div className="">
                <h1 className="font-semibold md:text-xl text-base">Background</h1>
              ...
              <div className="">
                <h1 className="font-semibold md:text-xl text-base">Sub Title</h1>
                <h1>{x.subtitle}</h1>
              </div>
              <div className="">
                <h1 className="font-semibold md:text-xl text-base">Description</h1>
                <h1>{x.des}</h1>
              </div>
            </div>
            <div className="flex space-x-8 py-4">
              <Button className="bg-blue-500 hover:bg-blue-400">
                <Link to={`/about/edit/${x.id}`}>
                  Edit
                </Link>
              </Button>
